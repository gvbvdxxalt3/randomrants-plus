...
var randomRantsAbout = [
  ...
  },
  {
    ...
    children: [
      {
        element: "li",
        textContent: "Anyone looking for ways to talk online or enjoy online hangouts",
      },
      {element: "br"},
      {
        element: "li",
        textContent: "Students that need a break, or wanting to escape school and enter the virtual world",
      },
      {element: "br"},
      {
        element: "li",
...

  {
    ...
    children: [
      {
        element: "span",
        textContent: "Also, Random Rants + also has a big history of how it was created - "
      },
      {
        element: "a",
        href: "./history",
